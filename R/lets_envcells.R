...
#' (mean of the \emph{n} smallest distances to zero-richness cells). Default = 0.1.
...
#'   \item \code{Area}: Summed area of the associated geographic cells.
#'   \item \code{Isolation (Min.)}, \code{Isolation (1st Qu.)}, \code{Isolation (Median)},
#'         \code{Isolation (Mean)}, \code{Isolation (3rd Qu.)}, and \code{Isolation (Max.)}:
#'         Summary statistics of pairwise geographic distances among associated geographic cells.
#'   \item \code{Weighted Mean Distance to midpoint}: Negated distance from the cell to the
#'         frequency-weighted midpoint in standardized environmental space.
#'   \item \code{Mean Distance to midpoint}: Negated distance from the cell to the unweighted
#'         midpoint in standardized environmental space.
#'   \item \code{Minimum Zero Distance}: Minimum distance from the cell to any empty environmental cell.
#'   \item A column named according to \code{perc} (e.g., \code{Minimum 10\% Zero Distance}):
#'         Mean distance from the cell to the nearest fraction of empty environmental cells.
#'   \item \code{Distance to MCP border}: Distance from the cell to the environmental-space border.
#'   \item \code{Frequency Weighted Distance}: Frequency-weighted mean distance from the cell
