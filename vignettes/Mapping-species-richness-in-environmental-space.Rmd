...
*Note: I recommend using the latest development version (≥ v5.1) of the `letsR` package from [GitHub](https://github.com/macroecology/letsR), as the CRAN release (v5.0) does not yet include some of the example data used in this tutorial.*
